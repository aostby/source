    ...
    {      private static string strCompName = "TESTFORM";
        ...
        private void Init()
        {
          richTextBox1.Language = FastColoredTextBoxNS.Language.XML;
            ...
            try
            {
                if (File.Exists(Settings.Default.LastOpened))
                    m_last = new FileInfo(Settings.Default.LastOpened);
        ...
        private void InitComboBoxes()
        {
            ...
            try
            {
                comboBoxStyleSheet.SelectedIndex = comboBoxStyleSheet.FindStringExact(new FileInfo(Settings.Default.LastStylesheet).Name);
            }
            catch (Exception ex) { toolStripStatusLabelXML.Text = ex.Message; }
            try
            {
                comboBoxSchema.SelectedIndex = comboBoxSchema.FindStringExact(new FileInfo(Settings.Default.LastSchema).Name);
            }
            catch (Exception ex) { toolStripStatusLabelXML.Text = ex.Message; }
            try
            {
        ...
        private void buttonValidate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Settings.Default.LastSchema = schema.FullName;
            }
            catch (Exception)
            { }
        ...
        private void buttonFilelist_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var tempstring = Settings.Default.FileListPath;
            ...
            try
            {
                ...
                if (fbd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                        ...
                        richTextBox1.Parent.Update(); richTextBox1.Parent.Refresh();
                        Application.DoEvents();
                        Settings.Default.FileListPath = fbd.SelectedPath;
        ...
        private void UserContrl1_LOadDataMethod(FileInfo info)
        {
            ...
            if (richTextBox1.InvokeRequired)
            {
                ...
                {//Hvis filen er den samme som vi jobber på så oppdater skjermbildet med fersk kopi
                     richTextBox1.Invoke(new System.Windows.Forms.MethodInvoker(delegate { richTextBox1.OpenFile(info.FullName, Encoding.UTF8); }));
                }
                else
                {
        ...
        private void buttonTransform_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Settings.Default.LastStylesheet = stylesheet.FullName;
        ...
        private void RBDXMLForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                if (m_last != null && m_last.Exists)
                    Settings.Default.LastOpened = m_last.FullName;
        ...
        private void buttonMySchema_Click(object sender, EventArgs e)
        {
            ...
            {
                FileInfo info;
                string lastPath = Settings.Default.MySchema;
                ...
                if (info != null && info.Exists)
                {
                    ...
                    Settings.Default.MySchema = info.FullName;
                }
            }
            catch (Exception ex)
            {
        ...
        {
            FileInfo info;
            string lastPath = Settings.Default.MyStylesheet;
            ...
            if (info != null && info.Exists)
            {
                ...
                Settings.Default.MyStylesheet = info.FullName;
