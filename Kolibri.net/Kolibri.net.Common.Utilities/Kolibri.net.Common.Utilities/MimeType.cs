namespace Kolibri.net.Common.Utilities
{
    public static class MimeTypes
    {
        ...
        private static Dictionary<String, String> m_mimeTypeDict = new Dictionary<String, String>()
		{
            #region mimetypes
        ...
        {
            return Get(extension, m_mimeTypeDict["bin"]);
        }
        ...
        public static String Get(String extension, String defaultMimeType)
        {
            ...
            if (m_mimeTypeDict.ContainsKey(extension))
                return m_mimeTypeDict[extension];
            else
        ...
        {
            var myValue = m_mimeTypeDict.FirstOrDefault(x => x.Value == mimetype).Key;
            return myValue;
        }
        #endregion
    }
