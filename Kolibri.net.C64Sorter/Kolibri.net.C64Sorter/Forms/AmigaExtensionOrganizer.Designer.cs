...
{
    partial class AmigaExtensionOrganizer
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AmigaExtensionOrganizer));
            ...
            buttonExtensionSort.Text = "Organize files by common extensions";
            ...
            panel2.Controls.Add(buttonUnZip);
            ...
            buttonFlattenC64files.Text = "Flatten all files to current folder";
            ...
            // buttonUnZip
            // 
            buttonUnZip.BackColor = Color.DeepSkyBlue;
            buttonUnZip.FlatAppearance.BorderColor = SystemColors.ControlLightLight;
            buttonUnZip.FlatStyle = FlatStyle.Flat;
            buttonUnZip.Font = new Font("Microsoft Sans Serif", 15.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            buttonUnZip.ForeColor = SystemColors.ControlLightLight;
            buttonUnZip.Location = new Point(196, 387);
            buttonUnZip.Name = "buttonUnZip";
            buttonUnZip.Size = new Size(450, 44);
            buttonUnZip.TabIndex = 9;
            buttonUnZip.Text = "Unzip and sort";
            buttonUnZip.UseVisualStyleBackColor = false;
            buttonUnZip.Click += Organize_Click;
            // 
            // AmigaExtensionOrganizer
            // 
