...
namespace Kolibri.net.SilverScreen.Forms
{
    public partial class DetailsFormItem : Form
    {
        ...
        /*      public DetailsFormItem(string imdbId
        ...
        private async void buttonSimilar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Top100IMDbForm form = new Top100IMDbForm(_liteDB, imdbItems);
                form.ShowDialog();
        ...
        private async void buttonReviews_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var review = item["AuthorDetails"] as AuthorDetails;
                    if (review?.Rating != null)
                    {
                        item["Rating"] = $"{review.Rating} / 10";
                    }
                    else
                    {
                        item["Rating"] = "Ikke gitt";
                    }
                }
