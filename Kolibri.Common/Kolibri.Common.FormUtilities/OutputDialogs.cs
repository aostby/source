...
namespace Kolibri.Common.FormUtilities
{
    public class OutputDialogs
    {
        ...
        public static DialogResult ShowDataTableDialog(string title, DataTable table, System.Drawing.Size size)
        {
            ...
            form.Size = size;
            form.Text = title;
            form.Icon = Icons.IconFromImage(Kolibri.Common.Utilities.Controller.ResourceController.GetResouceObject("table") as Bitmap);
        ...
        internal static void FCTB_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyData == Keys.F5)
            {
                ...
                try
                {
                    ...
                    var Xele = XUtilities.GetElement(xdoc.Root, "xml");
                    if (Xele != null)
                    {
