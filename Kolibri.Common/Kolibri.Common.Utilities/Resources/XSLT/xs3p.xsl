...
.footer {
   ...
   <!--   <xsl:if test="$component/xsd:annotation/xsd:appinfo/b:recordInfo">
         <tr>
            <th>Application Data</th>
            <td>
               <xsl:for-each select="$component/xsd:annotation/xsd:appinfo/b:recordInfo">
                  <xsl:if test="position()!=1"><br/><br/></xsl:if>
        -->          <!--  <<xsl:apply-templates select="." mode="properties"/>-->
                 <!--<xsl:text>Å hallo jalla</xsl:text>--> 
               <!--<xsl:value-of select="$component/xsd:annotation/xsd:appinfo/b:recordInfo/b:fieldInfo[@notes]"/>-->
               <!--</xsl:for-each>
            </td>
         </tr>
      </xsl:if>-->
  ...
  -->
   <xsl:template name="PrintSampleDocumentation">
      ...
      <xsl:if test="normalize-space(translate($useJavaScript,'TRUE','true'))='true' and $component and $component/xsd:annotation/xsd:appinfo/xsd:fieldInfo">
         <xsl:variable name="documentation">
          <!--  <xsl:for-each select="$component/xsd:annotation/xsd:documentation"> -->
             <xsl:for-each select="$component/xsd:annotation/xsd:appinfo/xsd:fieldInfo"> 
