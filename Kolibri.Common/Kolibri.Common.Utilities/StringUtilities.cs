...
{/// <summary>
/// 2021-05-07 klassen ble gjort statisk pga extension ToInt32. Flytt til extension prosjekt dersom dette skaper problemer.
/// </summary>
...
"ZONE" };
        ...
        public static string[] TrimAll(string[] array, bool removeEmptyEntries)
        {
            string[] ret = ObjektUtilities.ObjectArrayToStringArray(array);
            if (removeEmptyEntries)
                ret = RemoveItem(ret, string.Empty);
            return ret;
        }
