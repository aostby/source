...
namespace Kolibri.Common.Utilities
{
    public class ImageUtilities
    {
        ...
        public static Bitmap GetIconFromFile(FileInfo file)
        {
            Bitmap ret = null;
            try
            {

                ret = Icons.IconFromExtension(file.Extension, Icons.SystemIconSize.Large).ToBitmap(); //   IconExtractor(file.FullName).GetIcon(0).ToBitmap();
