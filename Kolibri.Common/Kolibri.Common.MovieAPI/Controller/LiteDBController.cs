...
namespace Kolibri.Common.MovieAPI.Controller
{
    ...
    public class LiteDBController
    {
        ...
        public LiteDBController(  bool exclusiveAccess = false, bool readOnly = true, bool seriesDB = false, FileInfo dbPath=null)
        {
            _seriesDB = seriesDB;
            ...
            try
            {
                if (dbPath == null && !string.IsNullOrEmpty(LastBConnectionString))
                {
