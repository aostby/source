...
namespace Kolibri.Common.MovieAPI.Controller
{
    public class SubDLSubtitleController
    {
        ...
        private static string baseurl = "https://api.subdl.com/api/v1/subtitles";
        public static string apikey = "2gHHygdT4rS_uTtd11AlLun6f-eYjWgU";
        public static string languages = "NO,EN";
        ...
        public static SubDL SearchByNameAndType(string name, string year, string type = "tv")
        {
            SubDL ret = null;
        ...
        public static SubDL SearchBySD_ID(string sd_id)
        {
            SubDL ret = null;
        ...
        public static SubDL SearchByFileName(string filename)
        {
            SubDL ret = null;
        ...
        private static SubDL Execute(  string url)
        {
            SubDL ret = null;
            try
            {
        ...
        public static SubDL SearchByItemValues(Item mmi)
        {
            SubDL ret = null;
