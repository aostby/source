...
namespace MoviesFromImdb
{
    public partial class MovieDetailsForm : Form
    {
        ...
        private LiteDBController _liteDBController; 
        ...
        public MovieDetailsForm(WatchList obj)
        {
            InitializeComponent();
        ...
        private void Init(string imdbId=null) {
            ...
            {if (_liteDBController == null) { _liteDBController = new LiteDBController(false, false, false); }
               var tmp =  _liteDBController.FindFile(imdbId);
                if (tmp != null) { linkLabelOpenFilePath.Tag = tmp.FullName; linkLabelOpenFilePath.Visible = true;
                   ...
                   var tmpM=  _liteDBController.FindItem(imdbId);
                    if (tmpM == null)
                    {
