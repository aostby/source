...
namespace SortPics.Controller
{
    public class LiteDBController
    {
        ...
        public string LastBConnectionString
        {
            ...
            {
                if (_seriesDB)
                    return AccessConfig.LastSeriesDBConnectionString;
                else
                    return AccessConfig.LastOMDBConnectionString;
            }
        }
        ...
        public LiteDBController(bool exclusiveAccess = false, bool readOnly = true, bool seriesDB = false)
        {
            ...
            {
                if (_seriesDB)
                    AccessConfig.LastSeriesDBConnectionString = ConnectionString.Filename;
                else
